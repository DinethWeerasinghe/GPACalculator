<?php
    ...
    if(!empty($_POST)){
        ...
        if($result){
            $printmsg = "Your review was submitted...";
            $textcolor = "blue";
        }
        else{
            $printmsg = "Something went wrong... Your review was not submitted...";
            $textcolor = "red";
        }
...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="mt-2" style="padding: 5px; text-align: center">
            <button type="button" class="btn btn-success" onclick="location.href='review.php';"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left-circle-fill" viewBox="0 0 16 16">
